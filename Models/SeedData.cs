...
namespace Report.Models
{
    public class SeedData
    {
        public static async Task CreateUserRoles(IServiceProvider serviceProvider)
        {
            ...
            var UserManager = serviceProvider.GetRequiredService<UserManager<ReportUser>>();
            ...
            //Add Admin User
            ReportUser user = await UserManager.FindByEmailAsync("admin@admin.com");
            if (user == null)
            {
                var User = new ReportUser();
        ...
        public static void Initialize(IServiceProvider serviceProvider)
        {
            ...
            DbContextOptions<FeedbackPortalContext>>()))
            {
                ...
                new Employee { /*Id = 1, */Name = "Rob Reiner", Number = "256-398", Email = "robreiner@employee.com", Rating = 0 },
                new Employee { /*Id = 2, */Name = "Ivan Reitman", Number = "789-632", Email = "ivanreitman@employee.com", Rating = 0 },
                new Employee { /*Id = 3, */Name = "Howard Hawks", Number = "125-874", Email = "howardhawks@employee.com", Rating = 0 }
                );
                context.SaveChanges();
                context.Client.AddRange(
                new Client { /*Id = 1, */Name = "Billy Crystal", Number = "125-489", Email = "billycrystal@client.com" },
                new Client { /*Id = 2, */Name = "Meg Ryan", Number = "985-126", Email = "megryan@client.com" },
                new Client { /*Id = 3, */Name = "Carrie Fisher", Number = "358-745", Email = "carriefisher@client.com" },
                new Client { /*Id = 4, */Name = "Bill Murray", Number = "964-158", Email = "billmurray@client.com" },
                new Client { /*Id = 5, */Name = "Dan Aykroyd", Number = "258-631", Email = "danaykroyd@client.com" },
                new Client { /*Id = 6, */Name = "Sigourney Weaver", Number = "369-758", Email = "sigourneyweaver@client.com" }
                );
                context.SaveChanges();
